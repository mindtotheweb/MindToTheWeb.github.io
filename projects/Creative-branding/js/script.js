  ...
  $(window).scroll(function(){
   ...
   if (lastId !== id) {
       ...
       menuItems
         ...
         .end().filter("[href=#"+id+"]").parent().addClass("scroll");
   }                   
  });  
...
else 
{
  ...
  if ( $(window).width() > 1023) {  
    ...
    tiles = $("h2, h3, .about_item, .portfolio_item, .flex, .contact .content .form, .contact .content .fide ").fadeTo(0, 0);
